...
function shipping_rates_for_specific_states( $rates, $package ) {
    ...
    $enabled_states = array(
        "MD", "VA", "DC", "NC", "SC","NY", "PA", "WV", "AL", 'CT', 'DE', 'FL', "GA", 'IN', "KT", "ME","MA", "MI", "NH", "NJ", "OH", "VT", "TN"
    );
...
function shipping_notice_2(){
	echo '<p>Place your order by Wednesday, December 19th at noon to guarantee delivery by Christmas</p>';
}
