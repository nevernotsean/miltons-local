           ...
           <div class="row collapse">
             <div class="small-8 column">
               <p data-id="Email Address:p" >
                 <input data-id="Email Address:input" type="text" name="email" value="" maxlength="80" placeholder="you@emailaddress.com">
               </p>
             </div>
              <div class="small-4 column">
                <button type="submit" class="submit postfix button Button ctct-button Button--block Button-secondary" data-enabled="enabled">Subscribe</button>
              </div>
            </div>
       </form>
</div>
