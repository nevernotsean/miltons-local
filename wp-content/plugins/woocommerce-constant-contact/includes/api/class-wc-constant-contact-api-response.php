...
class WC_Constant_Contact_API_Response implements SV_WC_API_Response {
	...
	public function get_lists() {
		...
		if ( empty( $this->response_xml->entry ) ) {
			throw new SV_WC_API_Exception( __( 'Get Lists - Entries are missing', 'woocommerce-constant-contact' ) );
		}
	...
	public function get_contact_id() {
		...
		if ( empty( $this->response_xml->entry->id ) ) {
			throw new SV_WC_API_Exception( __( 'Contact ID is missing', 'woocommerce-constant-contact' ) );
		}
	...
	public function get_id() {
		...
		if ( empty( $this->response_xml->id ) ) {
			throw new SV_WC_API_Exception( __( 'Created contact ID missing', 'woocommerce-constant-contact' ) );
		}
	...
	public function get_stats() {
		...
		if ( empty( $this->response_xml->id ) ) {
			throw new SV_WC_API_Exception( __( 'List ID is missing', 'woocommerce-constant-contact' ) );
		}
