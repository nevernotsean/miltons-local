...
(function($) {
    ...
    AdminUI = {
        ...
        show_ThemeDetails: function(current_dropdown) {
            ...
            if ( ! current_dropdown ) {
                current_dropdown = jQuery('select[name=csl-slplus-theme]');
                set_options = false;
            }
        ...
        init_flyout_menus: function() {
            ...
            $('.flyout-menu a').on('click', function(e) {
                ...
                if (clickedGroup != '') {
                    ...
                    $('#wpcsl-nav li').removeClass('open').removeClass('current').find('.sub-menu').hide().removeClass('open');
                    parentMenu.addClass('open').addClass('current').find('.sub-menu').hide().addClass('open');
                    $('#wpcsl-nav li.active').removeClass('active');
    ...
    $(document).ready(function() {
        ...
        // Expand Theme Divs
        //
        AdminUI.show_ThemeDetails( null );
