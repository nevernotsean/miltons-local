	...
	class SLPlus_AdminUI_Info extends SLPlus_BaseClass_Object {
		...
		private function default_broadcast() {
			return
				...
				'<h4>' . $this->slplus->text_manager->get_admin_text( 'plugin_created_by' ) . '</h4>' .
		...
		private function get_broadcast() {
			...
			$response = wp_remote_get( 'https://www.storelocatorplus.com/signage/index.php?sku=SLP4', array( 'timeout' => 30 ) );
